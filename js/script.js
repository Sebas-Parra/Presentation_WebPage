let imagenes = ["/img/imglist/AnimalWeight.jpeg",
    "/img/imglist/YoutubeDowloader.jpeg",
    "/img/imglist/Payroll.png"]

let projects = ["Animals weight", "Youtube-Downloader",
    "Subcontractors' payroll"
]

let linksProjects = ["hola", "https://github.com/Sebas-Parra/Youtube-Downloader.git", ""]
...
for(let i = 0; i < imagenes.length;i++){
    ...
    text += `<div class="book">
            <div class="Project">
        <p><img src="${imagenes[i]}" alt="Imagen ${i + 1}"></p>
            <section class="btn">
            <a href="${linksProjects[i]}">
            <button class="but">
